 ...
 */
public class FechasEquivalenciaBeforeAfterçClassTest {
    
    private static FechasEquivalenciaBeforeAfterçClassTest instance;
    
    public FechasEquivalenciaBeforeAfterçClassTest() {
    }
    
    @BeforeClass
    public static void setUpClass() {
        
        instance = new FechasEquivalenciaBeforeAfterçClassTest(); 
